...
Ready to contribute? Here's how to set up `video_game_sales_dashboard` for local development.

1. Download a copy of  `video_game_sales_dashboard` locally.
...
Please note that the `video_game_sales_dashboard` project is released with a 
